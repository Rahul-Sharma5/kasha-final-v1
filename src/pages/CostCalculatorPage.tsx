...
const CostCalculatorPage: React.FC = () => {
    ...
    const handleDownloadPdf = async () => {
        ...
        pdf.setFontSize(24);
        pdf.setTextColor('#43af98'); // Brand color
    ...
    return (
        <div className="bg-brand-light dark:bg-brand-dark">
            ...
            <style>{`
                .range-slider::-webkit-slider-thumb { -webkit-appearance: none; appearance: none; width: 25px; height: 25px; background: #43af98; cursor: pointer; border-radius: 50%; }
                .range-slider::-moz-range-thumb { width: 25px; height: 25px; background: #43af98; cursor: pointer; border-radius: 50%; }
            `}</style>
        </div>
    );
};
